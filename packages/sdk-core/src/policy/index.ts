...
export {
  ...
  signedObjectIdFor,
  validateOperationalKeyAuthorizationSignedShape,
  validateOperationalKeyAuthorizationUnsigned,
  ...
  verifySignedObject,
  type JsonObject,
  type OperationalKeyAuthorization,
  type OperationalKeyRole,
  type Policy,
  ...
  type UnsignedOperationalKeyAuthorization,
  type UnsignedPolicy,
