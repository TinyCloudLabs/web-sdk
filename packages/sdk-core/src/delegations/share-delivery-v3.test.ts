...
const envelope = {
  ...
  policy: { policyId: "pol_example", credentialRequirement: { credentialType: "opencredentials.email/v1" } },
...
function response(overrides: Record<string, unknown> = {}): Uint8Array {
  const invitation = {
    ...
    credentialType: envelope.policy.credentialRequirement.credentialType,
