...
export function ScrollButton({
	...
	return (
		<Button
			...
			size="icon"
			className={cn(
				"absolute bottom-4 rounded-full shadow-lg hover:bg-slate-100 dark:hover:bg-slate-800",
		...
		<ScrollArea className="flex-1 relative">
			...
			{showScrollButton && (
				<ScrollButton
					...
					alignment={scrollButtonAlignment}
					className="absolute bottom-4 rounded-full shadow-lg hover:bg-slate-100 dark:hover:bg-slate-800"
				/>
			)}
		</ScrollArea>
	);
