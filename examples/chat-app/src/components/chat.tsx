		...
		useChat({
			...
			initialMessages: [
				...
				},
				{
					id: "8",
					content:
						"For a team of 5 developers, I'd recommend:\n\n##### Primary Choice: Jira Software\n\n**Advantages:**\n- 🔧 Built for development teams\n- 📊 Great agile workflows\n- 🔄 Git integration\n- 📱 Mobile apps\n\n##### Alternative: ClickUp\n\n**Benefits:**\n- 💰 Cost-effective\n- 🎨 More flexible\n- 🚀 Faster setup\n\n```\nRecommended Setup:\n- Sprint Length: 2 weeks\n- Board Structure:\n  - Backlog\n To Do\n In Progress\n Code Review\n Testing\n Done\n- Key Features:\n Story Points\n Time Tracking\n Reports\n```\n\nWould you like me to explain how set up the recommended workflow in either these tools?",
					role: "assistant",
				},
			],
			onFinish: (message) => {
